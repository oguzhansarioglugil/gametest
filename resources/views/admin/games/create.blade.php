...
@section('page-description', 'Sisteme yeni bir oyun ekleyin')
    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                    <span class="text-gray-500">Yeni Oyun Ekle</span>
                </div>
            </li>
        </ol>
    </nav>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function addRequirement() {
        ...
        // CPU Selection with Autocomplete
        requirementDiv.querySelector('.add-cpu-btn').addEventListener('click', function() {
            ...
            cpuDiv.innerHTML = `
                <div class="flex-1 relative">
                    ...
                    <input type="hidden" name="requirements[${requirementIndex}][cpus][]" class="cpu-id-input">
        ...
        // GPU Selection with Autocomplete
        requirementDiv.querySelector('.add-gpu-btn').addEventListener('click', function() {
            ...
            gpuDiv.innerHTML = `
                <div class="flex-1 relative">
                    ...
                    <input type="hidden" name="requirements[${requirementIndex}][gpus][]" class="gpu-id-input">
